                     ...
                     function ($scope, $timeout, $transition) {
                        ...
                        self.select = $scope.select = function (nextSlide, direction) {
                           ...
                           function goNext() {
                              ...
                              if (self.currentSlide && angular.isString(direction) && !$scope.noTransition
                                  && nextSlide.$element) {
   ...
   'ui.bootstrap.position'
      ...
      .controller('DatepickerController', [
                     ...
                     function ($scope, $attrs, $parse, $interpolate, $timeout, $log, dateFilter, datepickerConfig) {
                        ...
                        this.activeDate = angular.isDefined($attrs.initDate) ? $scope.$parent.$eval($attrs.initDate) :
                                          new Date();
                        ...
                        this.refreshView = function () {
                           if (this.element) {
                              ...
                              ngModelCtrl.$setValidity('date-disabled', !date || (this.element
                        ...
                        this.isDisabled = function (date) {
                           return ((this.minDate && this.compare(date, this.minDate) < 0) || (this.maxDate
                        ...
                        $scope.toggleMode = function (direction) {
                           ...
                           if (($scope.datepickerMode === self.maxMode && direction === 1) || ($scope.datepickerMode
                                                                                               === self.minMode
                                                                                               && direction === -1)) {
                              return;
                           }
                       ...
                       return {
                          ...
                          link       : function (scope, element, attrs, ctrl) {
                             ...
                             function getDaysInMonth(year, month) {
                                return ((month === 1) && (year % 4 === 0) && ((year % 100 !== 0) || (year % 400
                                                                                                     === 0))) ? 29 :
                                       DAYS_IN_MONTH[month];
                             }
                       ...
                       return {
                          ...
                          link       : function (scope, element, attrs, ctrl) {
                             ...
                             ctrl._refreshView = function () {
                                ...
                                for (var i = 0, start = getStartingYear(ctrl.activeDate.getFullYear()); i < range;
                                     i++) {
                                   years[i] = angular.extend(ctrl.createDateObject(new Date(start
                                                                                            + i, 0, 1), ctrl.formatYear), {
                                                                uid: scope.uniqueId + '-' + i
                                                             });
                                }
                       ...
                       return {
                          ...
                          link       : function (scope, element, attrs) {
                             ...
                             scope.close = function (evt) {
                                ...
                                if (modal && modal.value.backdrop && modal.value.backdrop != 'static' && (evt.target
                                                                                                          === evt.currentTarget)) {
                                   evt.preventDefault();
                                   evt.stopPropagation();
                         ...
                         function ($injector, $rootScope, $q, $http, $templateCache, $controller, $modalStack) {
                            ...
                            function getTemplatePromise(options) {
                               return options.template ? $q.when(options.template) :
                                      $http.get(angular.isFunction(options.templateUrl) ? (options.templateUrl)() :
                                                options.templateUrl,
                            ...
                            return {
                               ...
                               compile : function (tElem, tAttrs) {
                                  ...
                                  return function link(scope, element, attrs) {
                                     ...
                                     var popupTimeout;
                                     var appendToBody = angular.isDefined(options.appendToBody) ? options.appendToBody :
                                                        false;
                                     ...
                                     scope.tt_animation = angular.isDefined(animation) ? !!animation :
                                                          options.animation;
...
angular.module('ui.bootstrap.progressbar', [])
      ...
      .controller('ProgressController', [
                     ...
                     function ($scope, $attrs, progressConfig) {
                        ...
                        this.bars = [];
                        $scope.max = angular.isDefined($attrs.max) ? $scope.$parent.$eval($attrs.max) :
                                     progressConfig.max;
      ...
      .controller('RatingController', [
                     ...
                     function ($scope, $attrs, ratingConfig) {
                        ...
                        this.init = function (ngModelCtrl_) {
                           ...
                           this.stateOn = angular.isDefined($attrs.stateOn) ? $scope.$parent.$eval($attrs.stateOn) :
                                          ratingConfig.stateOn;
                           this.stateOff = angular.isDefined($attrs.stateOff) ? $scope.$parent.$eval($attrs.stateOff) :
                                           ratingConfig.stateOff;

                           var ratingStates = angular.isDefined($attrs.ratingStates) ?
                                              $scope.$parent.$eval($attrs.ratingStates) :
                                              new Array(angular.isDefined($attrs.max) ?
                       ...
                       return {
                          ...
                          link   : function (originalScope, element, attrs, modelCtrl) {
                             ...
                             var inputFormatter = attrs.typeaheadInputFormatter ?
                                                  $parse(attrs.typeaheadInputFormatter) : undefined;
